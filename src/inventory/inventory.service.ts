...
export class InventoryService {
   ...
   * @param unitCostOverride Costo unitario explícito para valuar el movimiento.
   *        Por defecto el Kardex valúa al costo promedio vigente del producto.
   *        En reversiones (ej. cancelación de una compra ya recibida) la mercancía
   *        debe salir al costo REAL al que entró, no al promedio actual; de lo
   *        contrario el valor del inventario queda inflado o diluido.
